...
261 backend unit tests + 15 frontend tests passing; 2 Postgres-gated + 3 Bedrock-gated integration tests deselect by default. Ruff and mypy strict clean across 111 source files.
