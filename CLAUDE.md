...
320 backend unit tests + 57 frontend tests passing; 2 Postgres-gated + 3 Bedrock-gated integration tests deselect by default. Ruff and mypy strict clean across 115 source files.
