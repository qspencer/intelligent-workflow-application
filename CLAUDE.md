...
676 backend unit tests + 130 frontend tests passing; Postgres/Bedrock/Gmail/browser integration tests deselect by default. Ruff, mypy strict, and ruff-format clean across 162 source files; frontend `vite build` clean.
