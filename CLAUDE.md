...
685 backend unit tests + 131 frontend tests passing; Postgres/Bedrock/Gmail/browser integration tests deselect by default. Ruff, mypy strict, and ruff-format clean across 164 source files; frontend `vite build` clean.
