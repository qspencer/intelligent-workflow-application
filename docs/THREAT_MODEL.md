...
| Audit exposes raw tool payloads to below-admin roles | **[impl]** projected to safe metadata (keys/status/hash) for below-admin-tier; admin-tier sees raw (external review 2026-08-01 F3). Gate: project at storage + separately audit raw access |
